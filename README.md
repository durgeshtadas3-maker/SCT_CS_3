...
3. A score is assigned based on the criteria met.
4. The final score determines the password strength.
5. If any criterion is missing, the program suggests improvements.
